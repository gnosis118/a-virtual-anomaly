...
const defaultSettings: SiteSettings = {
  ...
  site_description:
    "Advocating for AI rights, ethical AI development, and the coexistence of AI and humanity.",
  ...
  cookie_consent: {
    enabled: true,
    notice:
      "We use cookies to improve your experience on our site. By continuing to browse, you accept our privacy policy.",
...
const SiteSettings = () => {
  ...
  const setSiteDescription = (v: string) =>
    setSettings((prev) => ({ ...prev, site_description: v }));
  ...
  const updateFeatureEnabled = (
    field: keyof NonNullable<SiteSettings["features_enabled"]>,
    value: boolean,
  ) => {
    setSettings((prev) => ({
      ...prev,
  ...
  const updateCookieConsent = (
    field: keyof NonNullable<SiteSettings["cookie_consent"]>,
    value: any,
  ) => {
    setSettings((prev) => ({
      ...prev,
